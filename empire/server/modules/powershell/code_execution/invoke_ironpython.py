...
class Module(object):
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            'Name': 'Invoke-IronPython',

            'Author': ['@byt3bl33d3r', '@Cx01N'],

            'Description': ("Executes IronPython code using the embedded IPY engine."),
        ...
        self.options = {
            ...
            'ipyscript': {
                'Description': 'Base64 encoded IronPython code',
                'Required': True,
                'Value': ''
            },
        }
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        module_source = self.mainMenu.installPath + "/data/module_source/code_execution/Invoke-IronPython.ps1"
        if obfuscate:
