...
class Module(object):
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.options = {
            ...
            'NetOnly' : {
                'Description'   :   'Start the process using the LOGON_NETCREDENTIALS_ONLY flag '
                                    '(equivalent of running "runas.exe /netonly")',
                'Required'      :   False,
                'Value'         :   ''
            }
        }
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        moduleSource = self.mainMenu.installPath + "/data/module_source/management/Start-ProcessAsUser.ps1"
