...
class Module(object):
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Description': ("Executes SSharp from an embedded compiler within PowerShell. Compilation does not call csc.exe"),
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        module_source = self.mainMenu.installPath + "/data/module_source/code_execution/Invoke-SSharp.ps1"
        if obfuscate:
